...
const numPeopleToLive = document.querySelector("[data-cont-show]");
const numWhoLiveWithYou = document.querySelector("[data-cont-show-live]");
...
function handleCounter(
  ...
  const decBtn = document.querySelector(decBtnSelector);
  const incBtn = document.querySelector(incBtnSelector);
  const countDisplay = document.querySelector(displaySelector);
...
handleCounter("[data-dec]", "[data-inc]", "[data-cont-show]", 10);
handleCounter(
  "[data-dec-live]",
  "[data-inc-live]",
  "[data-cont-show-live]",
...
form.addEventListener("submit", function (e) {
  ...
  if (validationStep3()) {
    ...
    formObject.people_to_live_With = numPeopleToLive.textContent;
    formObject.people_live_With_you = numWhoLiveWithYou.textContent;
